...
with open(output_file_path, "w") as output_file:
    # Redirect stdout to the file while keeping the original stdout intact
...
# Now you can print to the console as usual
print("Contents also saved to", output_file_path)
