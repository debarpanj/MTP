...
# s.add(l2n1v1_1 >= -1, l2n1v1_1 <= 1)
# s.add(l2n1v2_1 >= -1, l2n1v2_1 <= 1)
# s.add(l2n2v1_1 >= -1, l2n2v1_1 <= 1)
# s.add(l2n2v2_1 >= -1, l2n2v2_1 <= 1)
# s.add(l2n3v1_1 >= -1, l2n3v1_1 <= 1)
# s.add(l2n3v2_1 >= -1, l2n3v2_1 <= 1)
# s.add(l2n4v1_1 >= -1, l2n4v1_1 <= 1)
# s.add(l2n4v2_1 >= -1, l2n4v2_1 <= 1)
# s.add(l2n5v1_1 >= -1, l2n5v1_1 <= 1)
# s.add(l2n5v2_1 >= -1, l2n5v2_1 <= 1)
# s.add(l2n6v1_1 >= -1, l2n6v1_1 <= 1)
# s.add(l2n6v2_1 >= -1, l2n6v2_1 <= 1)
# s.add(l2n7v1_1 >= -1, l2n7v1_1 <= 1)
# s.add(l2n7v2_1 >= -1, l2n7v2_1 <= 1)
# s.add(l2n7v2_1 >= -1, l2n7v2_1 <= 1)
...
# 		output_file.write(f"s.add(NN({inp1},{inp2},{inp3},{inp4},{inp5},{inp6},{inp7},{l2n1v1_1},{l2n2v1_1},{l2n3v1_1},{l2n4v1_1},{l2n5v1_1},{l2n6v1_1},{l2n7v1_1}) == {out[0]})\n")
# 		output_file.write(f"s.add(NN({inp1},{inp2},{inp3},{inp4},{inp5},{inp6},{inp7},{l2n1v2_1},{l2n2v2_1},{l2n3v2_1},{l2n4v2_1},{l2n5v2_1},{l2n6v2_1},{l2n7v2_1}) == {out[0]})\n")
...
s.add(NN(1,-1,-1.900390625,0.125,0.5,2,-2,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.0896181)
s.add(NN(1,-1,-1.900390625,0.125,0.5,2,-2,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.0896181)
s.add(NN(1,-1,-0.5,0.125,0.5,-0.5,-0.5,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.0)
s.add(NN(1,-1,-0.5,0.125,0.5,-0.5,-0.5,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.0)
s.add(NN(-22.6016593854,25.8464500039,7.6378934863,0,4.1416871897,-26.9834000108,12.9551001605,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.0114133)
s.add(NN(-22.6016593854,25.8464500039,7.6378934863,0,4.1416871897,-26.9834000108,12.9551001605,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.0114133)
s.add(NN(11.6141433856,-10.4069314137,0.2921305651,-12.8028159680,8.2027629618,4.1142747764,-2.4252827188,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.20615)
s.add(NN(11.6141433856,-10.4069314137,0.2921305651,-12.8028159680,8.2027629618,4.1142747764,-2.4252827188,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.20615)
s.add(NN(-3,-1,-3,0.125,0.5,-0.5,1,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.711054)
s.add(NN(-3,-1,-3,0.125,0.5,-0.5,1,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.711054)
s.add(NN(1,0,0,0.125,0.5,-0.5,-0.5,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.120942)
s.add(NN(1,0,0,0.125,0.5,-0.5,-0.5,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.120942)
s.add(NN(-6.5594115276,4.1715708042,-0.4942338115,0,0.4905333123,-5.8025839355,3.8830096363,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.0488717)
s.add(NN(-6.5594115276,4.1715708042,-0.4942338115,0,0.4905333123,-5.8025839355,3.8830096363,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.0488717)
s.add(NN(1,-0.25,-0.5,0.125,0.5,-0.5,-0.5,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1,l2n5v1_1,l2n6v1_1,l2n7v1_1) == 0.056792)
s.add(NN(1,-0.25,-0.5,0.125,0.5,-0.5,-0.5,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1,l2n5v2_1,l2n6v2_1,l2n7v2_1) == 0.056792)
...
# while s.check(l2n1v1_1==l2n1v2_1+0.0001, l2n2v1_1==l2n2v2_1+0.0001, l2n3v1_1==l2n3v2_1+0.0001, l2n4v1_1==l2n4v2_1+0.0001, l2n5v1_1==l2n5v2_1+0.0001, l2n6v1_1==l2n6v2_1+0.0001, l2n7v1_1==l2n7v2_1+0.0001) != unsat:
delta = RealVal(0.0001)

conditions = [
    And(l2n1v1_1 - l2n1v2_1 <= delta, l2n1v1_1 - l2n1v2_1 >= -delta),
    And(l2n2v1_1 - l2n2v2_1 <= delta, l2n2v1_1 - l2n2v2_1 >= -delta),
    And(l2n3v1_1 - l2n3v2_1 <= delta, l2n3v1_1 - l2n3v2_1 >= -delta),
    And(l2n4v1_1 - l2n4v2_1 <= delta, l2n4v1_1 - l2n4v2_1 >= -delta),
    And(l2n5v1_1 - l2n5v2_1 <= delta, l2n5v1_1 - l2n5v2_1 >= -delta),
    And(l2n6v1_1 - l2n6v2_1 <= delta, l2n6v1_1 - l2n6v2_1 >= -delta),
    And(l2n7v1_1 - l2n7v2_1 <= delta, l2n7v1_1 - l2n7v2_1 >= -delta)
]

while s.check(*conditions) != unsat:
	try:
	 m=s.model()
	except:
		break
