...
# ov1_1 = Real('ov1_1')
# ov2_1= Real('ov2_1')
in1, in2, in3, in4, in5, in6, in7 = [FP(f'in{i}', fp_precision) for i in range(1, 8)]
l1n1v1_1, l1n2v1_1, l1n3v1_1, l1n4v1_1, l1n5v1_1, l1n6v1_1, l1n7v1_1 = [FP(f'l1n{i}v1_1', fp_precision) for i in range(1, 8)]
l1n1v2_1, l1n2v2_1, l1n3v2_1, l1n4v2_1, l1n5v2_1, l1n6v2_1, l1n7v2_1 = [FP(f'l1n{i}v2_1', fp_precision) for i in range(1, 8)]
ov1_1 = FP('ov1_1', fp_precision)
ov2_1 = FP('ov2_1', fp_precision)


def NN(in1,in2,in3,in4,in5,in6,in7,l1n1_1,l1n2_1,l1n3_1,l1n4_1,l1n5_1,l1n6_1,l1n7_1):
	# l2out_1 = Real('l2out_1')
	l2out_1 = FP('l2out_1', fp_precision)
...
while s.check(ov1_1 != ov2_1,Or(l1n1v1_1!=l1n1v2_1,l1n2v1_1!=l1n2v2_1,l1n3v1_1!=l1n3v2_1,l1n4v1_1!=l1n4v2_1,l1n5v1_1!=l1n5v2_1,l1n6v1_1!=l1n6v2_1,l1n7v1_1!=l1n7v2_1)) == sat:
	m = s.model()
	ia = str(m[in1].as_string()) + " " + str(m[in2].as_string()) + " " + str(m[in3].as_string()) + " " + str(m[in4].as_string()) + " " + str(m[in5].as_string()) + " " + str(m[in6].as_string()) + " " + str(m[in7].as_string())
	print(ia)
	out = Cexec(ia)
